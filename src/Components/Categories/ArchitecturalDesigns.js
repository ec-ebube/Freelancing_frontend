...
function ArchitecturalDesigns() {
    ...
    if (data) {
        ...
        data.map((ports) => {
            if (ports.Category === "Architectural designs") {
                codeCat.push(ports)
    ...
    return (
        <div className='catBody'>
            <div className="welcome7">
                {!isLoading && <div><div className='fortext'><h3 className='catTexts'>
                    Elevate your experience, Connect or Join with the Best Architects through our website today!
                </h3></div>
                    <input
                        type="text"
                        id="myInput"
